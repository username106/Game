...
public class Generator3D : MonoBehaviour {
    ...
    void Start() {
        if (easy)
        {
            size = new Vector3Int(UnityEngine.Random.Range(7, 10), UnityEngine.Random.Range(7, 10), UnityEngine.Random.Range(7, 10));
            roomCount = UnityEngine.Random.Range(20, 50);
            roomMaxSize = new Vector3Int(UnityEngine.Random.Range(1, 3), UnityEngine.Random.Range(1, 3), UnityEngine.Random.Range(1, 3));
            //MyGen.easyl = true;
            //MyGen.mediuml = false;
            //MyGen.hardl = false;
        }
        if (medium)
        {
            size = new Vector3Int(UnityEngine.Random.Range(10, 15), UnityEngine.Random.Range(10, 15), UnityEngine.Random.Range(10, 15));
            roomCount = UnityEngine.Random.Range(50, 100);
            roomMaxSize = new Vector3Int(UnityEngine.Random.Range(2, 3), UnityEngine.Random.Range(2, 3), UnityEngine.Random.Range(2, 3));
            //MyGen.easyl = false;
            //MyGen.mediuml = true;
            //MyGen.hardl = false;
        }
        if (hard)
        {
            size = new Vector3Int(UnityEngine.Random.Range(15, 25), UnityEngine.Random.Range(15, 25), UnityEngine.Random.Range(15, 25));
            roomCount = UnityEngine.Random.Range(100, 150);
            roomMaxSize = new Vector3Int(UnityEngine.Random.Range(3, 4), UnityEngine.Random.Range(3, 4), UnityEngine.Random.Range(3, 4));
            //MyGen.easyl = false;
            //MyGen.mediuml = false;
            //MyGen.hardl = true; 
        }
    ...
    void PlaceCube(Vector3Int location, Vector3Int size, Material material) {
        ...
        else if(material == blueMaterial)
        {
            go.tag = "corridor";
        }
        else if (material == greenMaterial)
        {
